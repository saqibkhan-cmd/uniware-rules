...
# Parsing helpers exactly as they worked in production
...
if module == "FACILITY":
    ...
    with col1:
        ...
        if st.checkbox("Enable Combo / Bundle SKU Constraints", key="fac_chk_bsku"):
            b_in = st.text_input("Enter Bundle SKU(s):", placeholder="BUNDLE-01, BUNDLE-02", key="fac_inp_bsku")
        ...
        if st.checkbox("Enable Specific Order Tag Constraints", key="fac_chk_tag"):
            t_in = st.text_input("Enter Order
